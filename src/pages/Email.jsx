        ...
        <>
            <section className='d-flex p-5  pt-1'  >
                <main className='pt-5 pb-4 w-75'  >
                    <div className='pt-3  tw-font-semibold  tw-text-zinc-700 ' style={{ lineHeight: "80px", fontSize: "57px" }}>Rent a <span className='text-primary'>Place</span> away from <span className='text-primary'>Home</span> in the <span className='text-primary'>Metavere</span></div>
