...
function Nfts() {
    return (
        <>
            <section className="bg-primary tw-px-12 max-[973px]:tw-px-6 max-[415px]:tw-px-2  tw-flex gap-5 icons max-[769px]:tw-flex-col sect " style={{paddingTop:"80px",paddingBottom:"120px"}}>
